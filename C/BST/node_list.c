...
status_t ptrbst_get_end(ptrbst_list_t* p_list, bst_node_t** p_node)
{
...
status_t ptrbst_stack_peek(ptrbst_stack_t* p_stack, bst_node_t** p_bst_node)
{
    return(ptrbst_get_end(p_stack, p_bst_node));
